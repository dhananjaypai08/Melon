              ...
              {debugInfo && (
                <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-white/60">Expected Hash:</span>
                      <span className="text-white font-mono text-xs">
                        {debugInfo.expectedHash?.slice(0, 16)}...
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-white/60">Computed Hash:</span>
                      <span className="text-white font-mono text-xs">
                        {debugInfo.recomputedHash?.slice(0, 16)}...
                      </span>
                    </div>
                    <div className="flex justify-between">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span
                      className={`font-medium ${
                        exifDebugInfo && exifDebugInfo.exifDict
                          ? "text-emerald-300"
                          : "text-red-300"
                      }`}
                    >
                      {exifDebugInfo && exifDebugInfo.exifDict ? "Yes" : "No"}
                    </span>
                  </div>
                  {exifDebugInfo.exifDict && (
                    <>
                      ...
                      <div className="flex justify-between">
                        <span className="text-white/60">AI Proof Found:</span>
                        <span
                          className={`font-medium ${
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                ...
                <div className="bg-black/20 p-3 rounded-lg max-h-40 overflow-y-auto">
                  <pre className="text-xs text-white/70 whitespace-pre-wrap">
                    {exifDebugInfo && exifDebugInfo.debugLog
